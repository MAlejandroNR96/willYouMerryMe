...
FRASES = [
    ...
    'Amor de verdad '+emoji_heart+' significa crecer juntos a través de las dificultades, aprender del otro y nunca renunciar al amor que nos unió.'+emoji_cita,
